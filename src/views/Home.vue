<template>
  <div id="home" class="home" v-once>
    ...
    <section class="hero-section overlay bg-cover"
             v-background="'/images/banner/banner-1.jpg'">
      <div class="container">
        <div class="hero-slider">
          <carousel :autoPlay="true" :perPage="1" paginationActiveColor="#ffcf02"
                    paginationColor="#000" :paginationPadding="5">
            <slide v-for="(n, i) in 2" :key="i" class="text-center overflow-hidden">
              <!-- slider item -->
              <div class="hero-slider-item">
                <div class="row">
                  <div class="col-md-8 text-left">
                    <transition ></transition>
                    <h1 class="text-white" data-animation-out="fadeOutRight" data-delay-out="5" data-duration-in=".3" data-animation-in="fadeInLeft" data-delay-in=".1">Arise and Shine</h1>
                    <p class="text-muted mb-4" data-animation-out="fadeOutRight" data-delay-out="5" data-duration-in=".3" data-animation-in="fadeInLeft" data-delay-in=".4">Our motto propels the pupils and students to rise and shine wherever they find themselves, to excel in the classroom, perform on stage and succeed on the playing field.</p>
                    <a href="contact.html" class="btn btn-primary" data-animation-out="fadeOutRight" data-delay-out="5" data-duration-in=".3" data-animation-in="fadeInLeft" data-delay-in=".7">Enroll now</a>
                  </div>
                </div>
              </div>
            </slide>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 text-center">
            <h6 class="text-white font-secondary mb-0">Click to share in the success stories</h6>
            <h2 class="section-title text-white">{{info.motto}}</h2>
          ...
          <div v-for="(n, i) in 3" :key="i" class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
            <div class="card border-0 rounded-0 hover-shadow">
              <div class="card-img position-relative">
                ...
                <div class="card-date"><span>{{events[i].date.day}}</span><br>{{events[i].date.month}}</div>
              </div>
              <div class="card-body">
                <!-- location -->
...
export default {
  ...
  data () {
    return {
      ...
      achievements : [
        ...
        {
          event : 'Inter – private schools quiz competition',
          award : 'Second place',
        },
        {
  ...
  computed : {
    ...mapGetters('school', { info : 'info', academicSections : 'academicSections' }),
