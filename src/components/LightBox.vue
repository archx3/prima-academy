    ...
    <div class="nivo-lightbox-wrap">
      <div class="nivo-lightbox-content">
        <div class="nivo-lightbox-image" style="line-height: 373px; height: 100%;">
          <img :src="`/images/gallery/${subDir+'/'}${selectedImage[imageNameProp]}`" class="nivo-lightbox-image-display" alt="">
        </div>
      </div>
...
export default {
  ...
  methods : {
    ...
    next () {
      this.setSelectedImage(this.currentImageIndex < this.maxIndex ? this.galleryData.pics[this.currentImageIndex + 1] : this.galleryData.pics[0])
    },
    previous () {
